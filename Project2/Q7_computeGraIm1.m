function [graMag, graDir, wGraMag] = Q7_computeGraIm1(kps, image)
...
for i = 1:num
    ...
    window = image(max(cy-7,1):min(cy+7,floor(1024*0.8/sigma)),max(cx-7,1):min(cx+7,floor(1024*0.8/sigma)));
