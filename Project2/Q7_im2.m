...
trim = Q6_rotation(im,500,500,30,1.2);
trim_colored = Q6_rotation(image,500,500,30,1.2);
...
[graMag1, graDir1, wGraMag1] = Q7_computeGraIm2(kp1,diff1);
[graMag2, graDir2, wGraMag2] = Q7_computeGraIm2(kp2,diff2);
[graMag3, graDir3, wGraMag3] = Q7_computeGraIm2(kp3,diff3);
[graMag4, graDir4, wGraMag4] = Q7_computeGraIm2(kp4,diff4);
[graMag5, graDir5, wGraMag5] = Q7_computeGraIm2(kp5,diff5);

[V1,cyclicV1] = Q7_computefvIm2(kp1,diff1);
[V2,cyclicV2] = Q7_computefvIm2(kp2,diff2);
[V3,cyclicV3] = Q7_computefvIm2(kp3,diff3);
[V4,cyclicV4] = Q7_computefvIm2(kp4,diff4);
[V5,cyclicV5] = Q7_computefvIm2(kp5,diff5);
...
% Question 7
% Center at (500,500)
% Choose interested area (250-750, 250-750)
figure,
imshow(trim_colored,[]);

hold on
rectangle('Position',[250,250,500,500],'linewidth',1,'EdgeColor','w')
...
for i = 1:length(oV1)
    ...
    for j = 1:length(V1)
        ...
        sumj = sum(vecj(1:36));
        vecj = vecj/sumj;
        if (2*V1{j}(1,1)>250) && (2*V1{j}(1,1)<750) && (2*V1{j}(2,1)>250) && (2*V1{j}(2,1)<750)
...
for i = 1:length(oV2)
    ...
    for j = 1:length(V2)
        ...
        sumj = sum(vecj(1:36));
        vecj = vecj/sumj;
        if (4*V2{j}(1,1)>250) && (4*V2{j}(1,1)<750) && (4*V2{j}(2,1)>250) && (4*V2{j}(2,1)<750)
            dist = Q7_getBha(veci,vecj);
            if (dist<0.04)
                cx = 4*V2{j}(1,1);
                cy = 4*V2{j}(2,1);
...
for i = 1:length(oV3)
    ...
    for j = 1:length(V3)
        ...
        sumj = sum(vecj(1:36));
        vecj = vecj/sumj;
        if (8*V3{j}(1,1)>250) && (8*V3{j}(1,1)<750) && (8*V3{j}(2,1)>250) && (8*V3{j}(2,1)<750)
            dist = Q7_getBha(veci,vecj);
            if (dist<0.04)
                cx = 8*V3{j}(1,1);
                cy = 8*V3{j}(2,1);
...
for i = 1:length(oV4)
    ...
    for j = 1:length(V4)
        ...
        sumj = sum(vecj(1:36));
        vecj = vecj/sumj;
        if (16*V4{j}(1,1)>250) && (16*V4{j}(1,1)<250) && (16*V4{j}(2,1)>750) && (16*V4{j}(2,1)<750)
            dist = Q7_getBha(veci,vecj);
            if (dist<0.04)
                cx = 16*V4{j}(1,1);
                cy = 16*V4{j}(2,1);
...
for i = 1:length(oV5)
    ...
    for j = 1:length(V5)
        ...
        sumj = sum(vecj(1:36));
        vecj = vecj/sumj;
        if (32*V5{j}(1,1)>250) && (32*V5{j}(1,1)<750) && (32*V5{j}(2,1)>250) && (32*V5{j}(2,1)<750)
            dist = Q7_getBha(veci,vecj);
            if (dist<0.04)
                cx = 32*V5{j}(1,1);
                cy = 32*V5{j}(2,1);
